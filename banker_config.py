...
bot = telebot.TeleBot('1888975909:AAGAV-AM-WOx6t26AjI1pfZy957sa2QuLtc') # токен бота
admin = [1424781592, 1432563549, 3] # ID админов
support = 'sadovnikuu' # support без @

phone = '79373622228' # номер киви
token = '73894a1f20ff927def4e71d24cd0f891' # токен киви
